...
public:
    ...
    /// モデルファイルを読み込む
    LNRESULT createModel( Model** model_, void* data_, lnU32 size_, lnU32 flags_, LSharingKey key_ = lnNullKey );

    /// モデルファイルを読み込む
    LNRESULT createModel( Model** model_, File::IInStream* stream_, lnU32 flags_, LSharingKey key_ = lnNullKey );

    /// モデルファイルを読み込む (ファイル名指定)
    LNRESULT createModel( Model** model_, const lnChar* filename_,  lnU32 flags_, LSharingKey key_ = lnNullKey );
