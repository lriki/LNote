...
//=============================================================================
	...
	// ● 初期化
    //---------------------------------------------------------------------
    void ModelFrame::initializePMD( ModelCore* model_core_, const PMD_Bone* bone_data_, lnU32 index_ )
    {
	    ...
	    {
            mParent = &(mModelCore->getModelFrames()[ bone_data_->nParentNo ]);
    ...
    {
        //LSQTTransform tt = mLocalTransform;
        //tt.Translation += mOffset;
        //mWorldMatrix = tt;
        mWorldMatrix = mLocalTransform;
        
        //mWorldMatrix.translation(  );

        mWorldMatrix.translation( mOffset );

        if ( mParent ) mWorldMatrix *= mParent->mWorldMatrix;

        //mWorldMatrix.getPosition().cdump();
