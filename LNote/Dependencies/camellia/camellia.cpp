...
void Camellia_Ekeygen(  int n, const Byte *k, Byte *e )
{
	Byte t[64];
	Word u[20];
	int  i;
...
void Camellia_Encrypt(  int n, const Byte *p, const Byte *e, Byte *c )
{
	int i;
...
void Camellia_Decrypt(  int n, const Byte *c, const Byte *e, Byte *p )
{
	int i;
